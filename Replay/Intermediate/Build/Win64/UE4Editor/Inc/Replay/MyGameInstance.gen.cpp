...
// Cross Module References
	REPLAY_API UScriptStruct* Z_Construct_UScriptStruct_FS_ReplayInfo();
	UPackage* Z_Construct_UPackage__Script_Replay();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FDateTime();
	REPLAY_API UClass* Z_Construct_UClass_UMyGameInstance_NoRegister();
	REPLAY_API UClass* Z_Construct_UClass_UMyGameInstance();
	ENGINE_API UClass* Z_Construct_UClass_UGameInstance();
	REPLAY_API UFunction* Z_Construct_UFunction_UMyGameInstance_BP_OnFindReplaysComplete();
	REPLAY_API UFunction* Z_Construct_UFunction_UMyGameInstance_DeleteReplay();
	REPLAY_API UFunction* Z_Construct_UFunction_UMyGameInstance_FindReplays();
	REPLAY_API UFunction* Z_Construct_UFunction_UMyGameInstance_PlayReplayFromBP();
	REPLAY_API UFunction* Z_Construct_UFunction_UMyGameInstance_RenameReplay();
	REPLAY_API UFunction* Z_Construct_UFunction_UMyGameInstance_StartRecordingReplayFromBP();
	REPLAY_API UFunction* Z_Construct_UFunction_UMyGameInstance_StopRecordingReplayFromBP();
...
class UScriptStruct* FS_ReplayInfo::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern REPLAY_API uint32 Get_Z_Construct_UScriptStruct_FS_ReplayInfo_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FS_ReplayInfo, Z_Construct_UPackage__Script_Replay(), TEXT("S_ReplayInfo"), sizeof(FS_ReplayInfo), Get_Z_Construct_UScriptStruct_FS_ReplayInfo_CRC());
	}
	return Singleton;
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FS_ReplayInfo(FS_ReplayInfo::StaticStruct, TEXT("/Script/Replay"), TEXT("S_ReplayInfo"), false, nullptr, nullptr);
static struct FScriptStruct_Replay_StaticRegisterNativesFS_ReplayInfo
{
	FScriptStruct_Replay_StaticRegisterNativesFS_ReplayInfo()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("S_ReplayInfo")),new UScriptStruct::TCppStructOps<FS_ReplayInfo>);
	}
} ScriptStruct_Replay_StaticRegisterNativesFS_ReplayInfo;
	UScriptStruct* Z_Construct_UScriptStruct_FS_ReplayInfo()
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FS_ReplayInfo_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_Replay();
	...
	uint32 Get_Z_Construct_UScriptStruct_FS_ReplayInfo_CRC() { return 2800829755U; }
	...
	IMPLEMENT_CLASS(UMyGameInstance, 615147049);
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMyGameInstance(Z_Construct_UClass_UMyGameInstance, &UMyGameInstance::StaticClass, TEXT("/Script/Replay"), TEXT("UMyGameInstance"), false, nullptr, nullptr, nullptr);
